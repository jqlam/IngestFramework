...
def call_function(procedure_name, var1, var2):
    try:
        ...
        psq = "call pocket." + procedure_name + "('" + var1 + "','" + var2 + "');"
        cursor.execute(psq)
        psq = "select * from pocket.pokemon order by id"
        cursor.execute(psq)
...
def main(function_name, var1, var2):
    output = call_function(function_name, var1, var2)
    print(output)
